...
image: 0236.jpg
inventory_group: motion-object-presence
related:
- 0251-infrared-reciever
- 0260-photoresistor
- 0572-ultrasonic-ranger
- 0894-light-emitting-diode-led
parts:
- number: '0236'
---
...
The infrared LED is connected to constant power through a current-limiting resistor (just like any other LED). The photocell is connected to an analog pin along with a pull-down resistor and adjustment potentiometer. The resistor and potentiometer on the photocell serve a similar purpose as the voltage divider used with the [Photoresistor (see this page for more information)](/parts/0260/).
