...
To use a stepper motor, you will usually need a [stepper motor driver](/parts/stepper-motor-drivers/) to be able to supply enough power to it.

## Getting started

Please see the [Stepper Motor Driver page](/parts/stepper-motor-drivers/) for starter code and connections.

## Resources

- [Stepper Motor Driver](/parts/stepper-motor-drivers/)
