...
For an example on using the Breadboard Power Supply to power both the Arduino and a [Stepper Motor](/parts/stepper-motors/), please see the [Stepper Motor Driver page](/parts/stepper-motor-drivers/).
