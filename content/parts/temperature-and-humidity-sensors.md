...
related:
- thermistors
group: temperature-and-humidity-sensors
---
...
The ambient temperature is sensed using a [Thermistor](/parts/thermistors/). Please see the [Thermistor](/parts/thermistors/) page for more information.
